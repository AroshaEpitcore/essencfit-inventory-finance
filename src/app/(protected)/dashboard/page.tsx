    ...
    return (
      <div className="space-y-6">
        ...
        <div className="rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-4">
          <h2 className="font-semibold text-red-800 dark:text-red-200 mb-2">Configuration Error</h2>
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="rounded-xl bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 p-4">
          <h2 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">Error Loading Dashboard</h2>
